...
public class PersonalManuscriptDTO {
    ...
    public PersonalManuscriptDTO(String id, String contributors, String manuscriptName, String manuscriptKind, String manuscriptDes, String manuscriptTitle, Integer auditStatus, Date createTime, Integer limit, Integer page, List<UserInfo> userInfoList) {
        this.id = id;
        this.contributors = contributors;
        this.manuscriptName = manuscriptName;
        this.manuscriptKind = manuscriptKind;
