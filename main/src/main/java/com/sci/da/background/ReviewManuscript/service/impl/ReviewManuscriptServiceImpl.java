...
//    }
    ...
    @Override
    public IPage<ManuscriptDTO> getManuscriptMsg(Page page, ManuscriptDTO manuscriptDTO) {
        List<ManuscriptDTO> resList = baseMapper.getManuscriptMsg(page,manuscriptDTO);
